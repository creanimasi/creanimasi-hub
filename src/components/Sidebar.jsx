...
const NAV_ADMIN = [
  ...
  { path: '/users',      label: 'Kelola User',          badge: null,              badgeType: '' },
  ...
  { path: '/laporan',        label: 'Laporan Mingguan',  badge: null, badgeType: '' },
...
const ICONS = {
  ...
  '/users':      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7"/><circle cx="19" cy="7" r="2.5"/><path d="M19 9.5v3M17.5 11h3"/></svg>,
  ...
  '/laporan':    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14,2 14,8 20,8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><line x1="10" y1="9" x2="8" y2="9"/></svg>,
