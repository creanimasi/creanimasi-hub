...
const NAV_ITEMS = [
  ...
  { section: 'Guild' },
  { path: '/rpg/character',    label: 'Character Sheet',   badgeType: '' },
  { path: '/rpg/quests',       label: 'Papan Quest',       badgeType: '' },
  { path: '/rpg/guild',        label: 'Guild Hall',        badgeType: '' },
  { path: '/rpg/achievements', label: 'Pencapaian',        badgeType: '' },
